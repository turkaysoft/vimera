...
namespace Vimera{
    internal class TSModules{
        ...
        public class TS_LinkSystem{
            public const string
            // Main Control Links
            github_link_lv      = "https://raw.githubusercontent.com/turkaysoft/vimera/main/Vimera/SoftwareVersion.txt",
            github_link_lr      = "https://github.com/turkaysoft/vimera/releases/latest",
            // Social Links
        ...
        public class TS_ThemeEngine{
            ...
            public static readonly Dictionary<string, string> LightTheme = new Dictionary<string, string>{
                ...
                // ACCENT COLORS
                { "TSBT_AccentColor", "#7655B1" },
                { "AccentColorHover", "#8560C5" },
                { "AccentGreen", "#1C7A19" },
                { "AccentRed", "#CF1800" },
                // FOREGROUND / TEXT
                { "TSBT_LabelColor1", "#16191d" },
                { "TSBT_LabelColor2", "#646464" },
                { "HashCompareResultFE", "#FFFFFF" },
                // BORDERS & GRIDS
                { "SelectBoxColor", "#d1d7df" },
            ...
            public static readonly Dictionary<string, string> DarkTheme = new Dictionary<string, string>{
                ...
                // ACCENT COLORS
                { "TSBT_AccentColor", "#A476F3" },
                { "AccentColorHover", "#B088F5" },
                { "AccentGreen", "#26BB21" },
                { "AccentRed", "#FF4D4D" },
                // FOREGROUND / TEXT
                { "TSBT_LabelColor1", "#F5F5F5" },
                { "TSBT_LabelColor2", "#c3cbd6" },
                { "HashCompareResultFE", "#16191d" },
                // BORDERS & GRIDS
                { "SelectBoxColor", "#293036" },
                { "CheckBoxUnCheckBorderColor", "#394149" },
                // TRANSPARENCIES / ALPHAS
